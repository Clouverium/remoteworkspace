...
package net.mcreator.unknown.item;
...
import net.mcreator.unknown.procedures.BowRightclickedProcedure;
import net.mcreator.unknown.procedures.BowOnPlayerStoppedUsingProcedure;
import net.mcreator.unknown.procedures.BowItemInInventoryTickProcedure;
...
public class BowItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		BowRightclickedProcedure.execute(entity, ar.getObject());
		return ar;
	}
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		BowItemInInventoryTickProcedure.execute(entity, itemstack);
	}

	@Override
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entity, int time) {
		BowOnPlayerStoppedUsingProcedure.execute(entity, itemstack);
