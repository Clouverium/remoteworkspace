...
public class BowOnPlayerStoppedUsingProcedure {
		...
		if (entity.getPersistentData().getBoolean("BowLoading") && entity.getPersistentData().getDouble("BowPull") > 3) {
			{
				...
				if (!projectileLevel.isClientSide()) {
					...
					}.getArrow(projectileLevel, (float) (2 * (entity.getPersistentData().getDouble("BowPull") / itemstack.getOrCreateTag().getDouble("BowMaxPull"))), 1);
